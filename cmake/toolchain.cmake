...
FIND_FILE( RISCV_XPACK_GCC_COMPILER_EXE "riscv-none-elf-gcc.exe"
        PATHS ENV INCLUDE
)
FIND_FILE( RISCV_XPACK_GCC_COMPILER "riscv-none-elf-gcc"
        PATHS ENV INCLUDE
)
...
set( CMAKE_C_FLAGS "${CMAKE_C_FLAGS} -g -ffreestanding -Wl,--gc-sections" )
set( CMAKE_C_FLAGS "${CMAKE_C_FLAGS} -march=${CMAKE_SYSTEM_PROCESSOR} -mabi=${CMAKE_SYSTEM_ABI}" )

set(CMAKE_ASM_FLAGS "-march=${CMAKE_SYSTEM_PROCESSOR} -mabi=${CMAKE_SYSTEM_ABI}" )

set( CMAKE_C_FLAGS "${CMAKE_C_FLAGS}" CACHE STRING "" )
set( CMAKE_CXX_FLAGS "${CMAKE_C_FLAGS}" CACHE STRING "" )
set( CMAKE_ASM_FLAGS "${CMAKE_C_FLAGS}" CACHE STRING "" )
set( CMAKE_EXE_LINKER_FLAGS   "${CMAKE_EXE_LINKER_FLAGS}  -march=${CMAKE_SYSTEM_PROCESSOR}  -mabi=${CMAKE_SYSTEM_ABI} -nostartfiles " )